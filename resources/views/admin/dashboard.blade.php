@extends('layouts.app')
@section('page-title', __('dashboard.admin.page_title'))
...
<div class="row g-2 mb-3">
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_doctors') }}</div>
        </div>
    </div>
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_patients') }}</div>
        </div>
    </div>
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_appointments') }}</div>
        </div>
    </div>
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_today') }}</div>
        </div>
    </div>
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_pending') }}</div>
        </div>
    </div>
    <div class="col-4 col-md-2">
        <div class="stat-mini">
            ...
            <div class="sm-lbl">{{ __('dashboard.admin.stat_revenue') }}</div>
        </div>
    </div>
</div>
...
<div class="row g-4 mb-4" style="--chart-h: 220px;">
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-header py-2">{{ __('dashboard.admin.monthly_revenue', ['year' => date('Y')]) }}</div>
    ...
    <div class="col-lg-4">
        <div class="card h-100">
            <div class="card-header py-2">{{ __('dashboard.admin.appointment_status') }}</div>
...
<div class="card">
    <div class="card-header py-3">{{ __('dashboard.admin.recent_appointments') }}</div>
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            <thead>
                <tr>
                    <th>{{ __('dashboard.admin.th_patient') }}</th>
                    <th>{{ __('dashboard.admin.th_doctor') }}</th>
                    <th>{{ __('dashboard.admin.th_date') }}</th>
                    <th>{{ __('dashboard.admin.th_time') }}</th>
                    <th>{{ __('dashboard.admin.th_status') }}</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ __('dashboard.doctor_name', ['name' => $apt->doctor->name]) }}</td>
                ...
                @empty
                <tr><td colspan="5" class="text-center text-muted py-4">{{ __('dashboard.admin.no_appointments') }}</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
...
const months = {!! json_encode(__('dashboard.months')) !!};
...
new Chart(revenueCtx, {
    ...
    data: {
        labels: months,
        datasets: [{
            label: @json(__('dashboard.admin.revenue_axis')),
            data: revenueData,
