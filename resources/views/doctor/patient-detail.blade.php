...
@section('content')
<div class="mb-3">
    <a href="{{ route('doctor.patients') }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i> 환자 목록</a>
</div>
            ...
            <div class="card-body py-3">
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <div class="ms-auto d-flex gap-2 flex-wrap align-items-center">
                        ...
                        <a href="{{ route('doctor.prescriptions.create', $patient->id) }}" class="btn btn-sm btn-primary">
                            <i class="bi bi-file-earmark-medical"></i> 처방 작성
                        </a>
                    </div>
                </div>
            </div>
